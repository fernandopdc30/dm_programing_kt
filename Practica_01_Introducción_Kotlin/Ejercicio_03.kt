...
// Función principal que ejecuta la calculadora en un bucle hasta que el usuario decida salir
fun main(){
    while (true) {
        mostrarMenu()
        ...
        // Muestra error si se intenta dividir entre cero
